    ...
    <section class="relative overflow-hidden bg-gradient-to-b from-zinc-950 to-ink pb-16 pt-12 sm:pb-24 sm:pt-16 noise-bg">
      ...
      <div class="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div class="mt-8 flex flex-col gap-4 sm:flex-row">
          <a href="index.html#contact" class="inline-flex items-center justify-center gap-2 rounded-xl bg-racing px-6 py-3 text-base font-semibold text-white shadow-xl shadow-racing/30 transition hover:bg-racing/90">Demander un devis reprog<i data-lucide="arrow-right" class="h-5 w-5"></i></a>
...
{chr(10).join(cards)}
    ...
    <section class="border-t border-white/5 bg-ink py-14 sm:py-20">
      <div class="mx-auto max-w-3xl px-4 text-center sm:px-6">
        ...
        <a href="index.html#contact" class="mt-8 inline-flex items-center gap-2 rounded-xl bg-racing px-8 py-3.5 font-semibold text-white transition hover:bg-racing/90">Formulaire ou devis<i data-lucide="arrow-right" class="h-5 w-5"></i></a>
      </div>
    </section>
{LEGAL}
  </main>
